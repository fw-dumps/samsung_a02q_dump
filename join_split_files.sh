...
cat system/system/app/HoneyBoard/oat/arm/HoneyBoard.odex.* 2>/dev/null >> system/system/app/HoneyBoard/oat/arm/HoneyBoard.odex
rm -f system/system/app/HoneyBoard/oat/arm/HoneyBoard.odex.* 2>/dev/null
cat system/system/app/SamSungStikcerSource/SamSungStikcerSource.apk.* 2>/dev/null >> system/system/app/SamSungStikcerSource/SamSungStikcerSource.apk
rm -f system/system/app/SamSungStikcerSource/SamSungStikcerSource.apk.* 2>/dev/null
